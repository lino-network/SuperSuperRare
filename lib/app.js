  ...
  try {
    ...
    app.get('*', (req, res, next) => {
      ...
      if (cacheable) {
        ...
        const hit = cache.get(req.url + getCookieServer('darkMode', req.headers.cookie) + (req.headers['cloudfront-viewer-country'] && req.headers['cloudfront-viewer-country'][0].value) || '')
        if (hit) {
