...
const fontPageVisit = io.metric({
  type: 'counter',
  name: 'front page visit',
});

const trendingPageVisit = io.metric({
  type: 'counter',
  name: 'trending page visit',
});

const dashboardPageVisit = io.metric({
  type: 'counter',
  name: 'dashboard page visit',
});

let otherPageVisit = io.metric({
  type: 'counter',
  name: 'other page visit',
});

let reqsec = io.metric({
  name: 'req/sec',
  type: 'meter',
});
console.log(otherPageVisit);
console.log(reqsec);
console.log(io);
    ...
    app.get('*', (req, res, next) => {
      ...
      switch(req.path) {
        case '/':
          ...
          break;
        case '/dashboard':
          dashboardPageVisit.inc();
          break;
        case '/dashboard':
          trendingPageVisit.inc();
          break;
        default:
          otherPageVisit.inc();
          break;
