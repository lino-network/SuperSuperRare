...
function readServiceAddr(serviceName, defaultVal) {
  hostEnvKey = "LINOAPP_" + serviceName + "_SERVICE_HOST";
  portEnvKey = "LINOAPP_" + serviceName + "_SERVICE_PORT";

  host = process.env[hostEnvKey];
  if (host == undefined || host == "") {
      return defaultVal;
  }

  port = process.env[portEnvKey];
...
module.exports = (app, options) => {
  global.backendURL = readServiceAddr('APOLLO', 'https://graph.dlive.tv/');
  console.log(process.env);
  console.log('global backendURL', global.backendURL);
