...
module.exports = (app, options) => {
  global.backendURL = readServiceAddr('APOLLO', process.env.VUE_APP_GRAPHQL_HTTP || 'https://graph.dlive.tv/');
  console.log('++++++++', process.env)
  console.log('-------', readServiceAddr('APOLLO', process.env.VUE_APP_GRAPHQL_HTTP || 'https://graph.dlive.tv/'))
